    ...
    public static void main(String[] args) {
        checkAndPrint(
                ...
                new Question(
                        ...
                        new Choice(false, "s.addFirst(7); s.addFirst(0); s.addFirst(s.peekLast());                       (1A)"),
                ...
                new Question(
                        ...
                        new Choice(false, "Dynamisches Binden ist zusammen mit Untertypbeziehungen nötig.                (2A)"),
                        new Choice(false, "Private Methoden werden immer statisch gebunden.                              (2B)"),
                        new Choice(false, "Ein deklarierter Typ ist stets ein Interface, keine Klasse.                   (2C)"),
                        new Choice(false, "Objektmethoden werden im dynamischen Typ des Objekts ausgeführt.              (2D)"),
                        new Choice(false, "Klassenmethoden werden immer statisch gebunden.                               (2E)")
                ),
                ...
                new Question(
                        ...
                        new Choice(false, "Abstrakte Datentypen müssen keine Datenstrukturen beschreiben.                (3B)"),
                        ...
                        new Choice(false, "Abstrakte Datentypen beschreiben vorwiegend Schnittstellen.                   (3E)")
                ),
                ...
                new Question(
                        ...
                        new Choice(false, "Der Knoten mit Wert 3 ist Kind von dem mit Wert 7.                            (4A)"),
                        ...
                        new Choice(false, "Der Knoten mit Wert 3 ist ein Blattknoten.                                    (4E)")
                ),
                ...
                new Question(
                        ...
                        new Choice(false, "Durch 'p.n()' wird die Methode in M ausgeführt.                               (5B)"),
                        new Choice(false, "L und M müssen gleich sein.                                                   (5C)"),
                        new Choice(false, "Es gilt: 'p instanceof M'.                                                    (5D)"),

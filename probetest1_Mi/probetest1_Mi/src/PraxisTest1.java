...
public class PraxisTest1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test (2) size method:");
        testValue(l1.size(), 5);

        System.out.println("Test (3) insertBefore method:");
        l1.insertBefore(12, c3);
        testValue(l1.size(), 6);

        System.out.println("Test (4) toString method:");
        testEquals(new Caravan().toString(), "[]");
        testEquals(l1.toString(), "[(10-2=8), (5-2=3), (7-3=4), (12-3=9), (20-10=10), (2-0=2)] pace = 2");


        System.out.println("Test (5) detachFront method with size:");
        Caravan l2 = l1.detachFront(4);
        testValue(l1.size(), 2);
        testValue(l2.size(), 4);

        System.out.println("Test (6) detachFront method with toString:");
